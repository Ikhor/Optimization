...
int main(){
	...
	Poset *poset = construirPoset("rp_n25_p0.80_s1.txt" , custos, incomparabilidades);

	list<int*> solutions;
	int *v = new int[25];
	for (int i=0; i<25; i++) v[i] = i+1;
	solutions.push_back( v );
	MCLE * model = new MCLE(poset, custos, incomparabilidades, solutions);
